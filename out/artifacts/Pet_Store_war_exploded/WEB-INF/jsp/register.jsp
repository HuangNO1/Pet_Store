            ...
            <div class="card-wrapper">
                ...
                <div class="card fat">
                    <div class="card-body">
                        ...
                        <form method="POST" class="my-login-validation" action="/register" novalidate="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col flow">
                                        <input type="text" class="form-control" placeholder="驗證碼" required>
                                    </div>
                                    <div class="col-md-auto">
                                        <input type="button" class="ts primary button" id="btn" value="獲取驗證碼"
                ...
                <div class="footer">
                    Copyright &copy; 2019 &mdash; Pet Home
                </div>
            </div>
        </div>
    </div>
